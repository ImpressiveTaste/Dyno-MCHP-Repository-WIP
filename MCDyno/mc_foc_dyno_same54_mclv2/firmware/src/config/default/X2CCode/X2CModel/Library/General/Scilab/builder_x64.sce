// This file was generated by createLibraryBuilder.sce on 06-02-2025 03:05

jimport at.lcm.x2c.utils.Utils;
jimport java.io.File;

if isMajorVersionLessThan(2023) then
    // C compiler check for Scilab versions less than 2023 (6.x, 5.x)
    ...
    // C compiler check for Scilab 2023
    try
        has_compiler = haveacompiler();
    catch
        // function 'haveacompiler' may fail with an error if an unrecognized or no compiler is installed
        has_compiler = %f;
    end
end

// Display error message and return if no C compiler was found
if ~has_compiler then
    mprintf("Building General library for x64 system skipped (no compiler found).\n");
    return;
end
...
try
    ...
    names = [names,  "x2c_LookupTa_FiP16_C" "x2c_LookupTa_FiP32_C" "x2c_LookupTa_Float32_C" "x2c_LookupTa_Float64_C" "x2c_LookupTa_FiP16_RAM_C" "x2c_LookupTa_FiP32_RAM_C" "x2c_LookupTa_Float32_RAM_C" "x2c_LookupTa_Float64_RAM_C"];
    files = [files,  "x2c_LookupTa_FiP16_C.c" "x2c_LookupTa_FiP32_C.c" "x2c_LookupTa_Float32_C.c" "x2c_LookupTa_Float64_C.c" "x2c_LookupTa_FiP16_RAM_C.c" "x2c_LookupTa_FiP32_RAM_C.c" "x2c_LookupTa_Float32_RAM_C.c" "x2c_LookupTa_Float64_RAM_C.c"];
    ...
    names = [names,  "x2c_SaveSignal_Bool_C" "x2c_SaveSignal_FiP8_C" "x2c_SaveSignal_FiP16_C" "x2c_SaveSignal_FiP32_C" "x2c_SaveSignal_Float32_C" "x2c_SaveSignal_Float64_C"];
    files = [files,  "x2c_SaveSignal_Bool_C.c" "x2c_SaveSignal_FiP8_C.c" "x2c_SaveSignal_FiP16_C.c" "x2c_SaveSignal_FiP32_C.c" "x2c_SaveSignal_Float32_C.c" "x2c_SaveSignal_Float64_C.c"];
    ...
    names = [names,  "x2c_Sequencer_Bool_C" "x2c_Sequencer_FiP8_C" "x2c_Sequencer_FiP16_C" "x2c_Sequencer_FiP32_C" "x2c_Sequencer_Float32_C" "x2c_Sequencer_Float64_C"];
    files = [files,  "x2c_Sequencer_Bool_C.c" "x2c_Sequencer_FiP8_C.c" "x2c_Sequencer_FiP16_C.c" "x2c_Sequencer_FiP32_C.c" "x2c_Sequencer_Float32_C.c" "x2c_Sequencer_Float64_C.c"];
    ...
    names = [names,  "x2c_uSaveSignal_Bool_C" "x2c_uSaveSignal_FiP8_C" "x2c_uSaveSignal_FiP16_C" "x2c_uSaveSignal_FiP32_C" "x2c_uSaveSignal_Float32_C" "x2c_uSaveSignal_Float64_C"];
    files = [files,  "x2c_uSaveSignal_Bool_C.c" "x2c_uSaveSignal_FiP8_C.c" "x2c_uSaveSignal_FiP16_C.c" "x2c_uSaveSignal_FiP32_C.c" "x2c_uSaveSignal_Float32_C.c" "x2c_uSaveSignal_Float64_C.c"];
    ...
    mprintf("Library General for x64 system built.\n");

catch
    mprintf("Error building library General for x64 system: %s\n", lasterror());
end
