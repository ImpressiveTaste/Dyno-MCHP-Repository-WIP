// This file was generated by createIFunction.sci on 06-02-2025 03:04

function [x_sci,y_sci,typ_sci] = x2c_Acos(job, arg1, arg2)

thisBlockData.Library = "Math";
thisBlockData.block_type_name = "Acos";
thisBlockData.block_xcosfilename = "x2c_Acos";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Acos_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=acos(u)";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Acos_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/Acos.svg"
