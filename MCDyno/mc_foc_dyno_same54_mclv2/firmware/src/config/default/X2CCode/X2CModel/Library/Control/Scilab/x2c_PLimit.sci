...
function [x_sci,y_sci,typ_sci] = x2c_PLimit(job, arg1, arg2)

thisBlockData.Library = "Control";
thisBlockData.block_type_name = "PLimit";
thisBlockData.block_xcosfilename = "x2c_PLimit";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_PLimit_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_PLimit_"  + used_impl + "_C", 4);
