...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_AutoSwitch_"  + used_impl + "_C", 4);
...
define_in_style = ["textOpacity=50";"textOpacity=0";"textOpacity=50"];
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_AutoSwitch_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + strsubst(pwd(), "\", "/") + "/../Doc/Images/AutoSwitch.svg";
