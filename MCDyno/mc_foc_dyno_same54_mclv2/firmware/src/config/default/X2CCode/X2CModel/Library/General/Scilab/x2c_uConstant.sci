...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_uConstant_"  + used_impl + "_C", 4);
...
val = exprs(11);
if ~strcmp(val,"")
    define_style = "noLabel=0;displayedLabel=%10$s";
elseif ~strcmp(spin,"")
    define_style = "noLabel=0;displayedLabel=%11$s";
else
    define_style = "noLabel=0;displayedLabel=%10$s";
end
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_uConstant_"  + used_impl + "_C", 4);
...
style_tmp.fillColor="#E8D600";
style_tmp.gradientColor="#E8D600";
style_tmp.image = "file:///" + X2CRootDir + "Library/General/Doc/Images/Dummy.svg"
