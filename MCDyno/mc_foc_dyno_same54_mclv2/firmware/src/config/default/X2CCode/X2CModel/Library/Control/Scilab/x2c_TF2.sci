// This file was generated by createIFunction.sci on 06-02-2025 03:06
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_TF2_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=b<sub>2</sub>z<sup>2</sup> + b<sub>1</sub>z + b<sub>0</sub><br>-------------------<br>&nbsp<sub>&nbsp</sub>z<sup>2</sup> + a<sub>1</sub>z + a<sub>0</sub>";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_TF2_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../../Control/Doc/Images/Dummy.svg"
