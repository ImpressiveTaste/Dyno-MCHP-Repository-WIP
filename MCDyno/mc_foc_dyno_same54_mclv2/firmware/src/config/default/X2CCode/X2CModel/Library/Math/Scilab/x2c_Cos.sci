...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Cos_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=cos(u)";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Cos_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/Cos.svg"
