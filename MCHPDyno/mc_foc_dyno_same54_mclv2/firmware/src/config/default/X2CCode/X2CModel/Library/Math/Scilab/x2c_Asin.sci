...
function [x_sci,y_sci,typ_sci] = x2c_Asin(job, arg1, arg2)

thisBlockData.Library = "Math";
thisBlockData.block_type_name = "Asin";
thisBlockData.block_xcosfilename = "x2c_Asin";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Asin_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=asin(u)";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Asin_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/Asin.svg"
