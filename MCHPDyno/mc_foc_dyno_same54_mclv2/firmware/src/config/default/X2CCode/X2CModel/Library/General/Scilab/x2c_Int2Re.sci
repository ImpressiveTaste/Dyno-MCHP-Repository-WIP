...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Int2Re_"  + used_impl + "_C", 4);
...
if ~strcmp(used_impl,"FiP8_Float32") then

    define_style = "noLabel=0;displayedLabel=i8 &#8594 f32";

elseif ~strcmp(used_impl,"FiP16_Float32") then

    define_style = "noLabel=0;displayedLabel=i16 &#8594 f32";

elseif ~strcmp(used_impl,"FiP32_Float32") then

    define_style = "noLabel=0;displayedLabel=i32 &#8594 f32";

elseif ~strcmp(used_impl,"FiP8_Float64") then

    define_style = "noLabel=0;displayedLabel=i8 &#8594 f64";

elseif ~strcmp(used_impl,"FiP16_Float64") then

    define_style = "noLabel=0;displayedLabel=i16 &#8594 f64";

elseif ~strcmp(used_impl,"FiP32_Float64") then

    define_style = "noLabel=0;displayedLabel=i32 &#8594 f64";

elseif ~strcmp(used_impl,"Bool_Float32") then

    define_style = "noLabel=0;displayedLabel=b &#8594 f32";

elseif ~strcmp(used_impl,"Bool_Float64") then

    define_style = "noLabel=0;displayedLabel=b &#8594 f64";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Int2Re_"  + used_impl + "_C", 4);
