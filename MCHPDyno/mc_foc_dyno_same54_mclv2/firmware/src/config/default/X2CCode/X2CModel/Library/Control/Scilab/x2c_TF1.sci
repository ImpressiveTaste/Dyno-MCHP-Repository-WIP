...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_TF1_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=b<sub>1</sub>z + b<sub>0</sub><br>-----------<br>&nbsp<sub>&nbsp</sub>z + a<sub>0</sub>";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_TF1_"  + used_impl + "_C", 4);
