...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Sequencer_"  + used_impl + "_C", 4);
...
define_out_style = ["textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";]
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Sequencer_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/Sequencer.svg"
