...
function [x_sci,y_sci,typ_sci] = x2c_P(job, arg1, arg2)

thisBlockData.Library = "Control";
thisBlockData.block_type_name = "P";
thisBlockData.block_xcosfilename = "x2c_P";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_P_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_P_"  + used_impl + "_C", 4);
