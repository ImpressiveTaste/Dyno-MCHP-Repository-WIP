...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Real2I_"  + used_impl + "_C", 4);
...
if ~strcmp(used_impl,"Float32_FiP8") then

    define_style = "noLabel=0;displayedLabel=f32 &#8594 i8";

elseif ~strcmp(used_impl,"Float32_FiP16") then

    define_style = "noLabel=0;displayedLabel=f32 &#8594 i16";

elseif ~strcmp(used_impl,"Float32_FiP32") then

    define_style = "noLabel=0;displayedLabel=f32 &#8594 i32";

elseif ~strcmp(used_impl,"Float64_FiP8") then

    define_style = "noLabel=0;displayedLabel=f64 &#8594 i8";

elseif ~strcmp(used_impl,"Float64_FiP16") then

    define_style = "noLabel=0;displayedLabel=f64 &#8594 i16";

elseif ~strcmp(used_impl,"Float64_FiP32") then

    define_style = "noLabel=0;displayedLabel=f64 &#8594 i32";

elseif ~strcmp(used_impl,"Float64_Bool") then

    define_style = "noLabel=0;displayedLabel=f64 &#8594 b";

elseif ~strcmp(used_impl,"Float32_Bool") then

    define_style = "noLabel=0;displayedLabel=f32 &#8594 b";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Real2I_"  + used_impl + "_C", 4);
