// This file was generated by createIFunctionIO.sci on 06-02-2025 03:05
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Outport_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Outport_"  + used_impl + "_C", 4);
    model.in = 1;
    model.evtin = [1];
    model.out = 1;
    ...
    x_sci.graphics.style = struct2string(style);
    ...
    x_sci.graphics.out_style = "noLabel=true;shape=triangle;fillColor=black";// hide input port label
    x_sci.graphics.in_style = "noLabel=true;shape=triangle;fillColor=black";// hide output port label
end
