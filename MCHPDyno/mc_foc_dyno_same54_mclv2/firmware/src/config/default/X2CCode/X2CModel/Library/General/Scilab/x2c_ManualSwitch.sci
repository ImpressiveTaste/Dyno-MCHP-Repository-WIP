...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_ManualSwitch_"  + used_impl + "_C", 4);
...
if ~strcmp(val,"")
	if strtod(spin) <> 0
		define_style = "image=file:///" + X2CRootDir + "Library/General/Doc/Images/ManualSwitch1.svg";
	else
		define_style = "image=file:///" + X2CRootDir + "Library/General/Doc/Images/ManualSwitch0.svg";	
	end
elseif ~strcmp(spin,"")
	if strtod(val) <> 0
		define_style = "image=file:///" + X2CRootDir + "Library/General/Doc/Images/ManualSwitch1.svg";
...
define_in_style = ["textOpacity=0";"textOpacity=0";"textOpacity=0"];
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_ManualSwitch_"  + used_impl + "_C", 4);
