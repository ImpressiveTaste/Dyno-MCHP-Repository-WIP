...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Selector_"  + used_impl + "_C", 4);
...
define_in_style = ["textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";"textOpacity=0";];
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Selector_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/Selector.svg";
