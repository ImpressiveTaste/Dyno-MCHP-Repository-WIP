...
\cellcolor[gray]{0.8}\textbf{Name} & \cellcolor[gray]{0.8}\textbf{ID} & \cellcolor[gray]{0.8}\textbf{Description}\tabularnewline
\hline
...
\begin{tabular}{l l}
\textbf{FiP16} & 64 Bit Floating Point Implementation with look-up table located in RAM\tabularnewline
\textbf{FiP32} & 32 Bit Fixed Point Implementation with look-up table located in Flash memory\tabularnewline
\textbf{Float32} & 32 Bit Floating Point Implementation with look-up table located in Flash memory\tabularnewline
\textbf{Float64} & 64 Bit Floating Point Implementation with look-up table located in Flash memory\tabularnewline
\textbf{FiP16\_RAM} & 16 Bit Fixed Point Implementation with look-up table located in RAM\tabularnewline
\textbf{FiP32\_RAM} & 32 Bit Fixed Point Implementation with look-up table located in RAM\tabularnewline
\textbf{Float32\_RAM} & 32 Bit Floating Point Implementation with look-up table located in RAM\tabularnewline
\textbf{Float64\_RAM} & 64 Bit Floating Point Implementation with look-up table located in RAM\tabularnewline
\end{tabular}
...
\XtoCImplementation{Float32\_RAM}
\nopagebreak[0]
...
\XtoCImplementation{Float64\_RAM}
\nopagebreak[0]
...
\InputIfFileExists{\XcHomePath/Library/General/Doc/Test-Results/Test_LookupTable1D_FiP16_RAM.tex}{}{}
\InputIfFileExists{\XcHomePath/Library/General/Doc/Test-Results/Test_LookupTable1D_FiP32_RAM.tex}{}{}
\InputIfFileExists{\XcHomePath/Library/General/Doc/Test-Results/Test_LookupTable1D_Float32_RAM.tex}{}{}
\InputIfFileExists{\XcHomePath/Library/General/Doc/Test-Results/Test_LookupTable1D_Float64_RAM.tex}{}{}
\fi
