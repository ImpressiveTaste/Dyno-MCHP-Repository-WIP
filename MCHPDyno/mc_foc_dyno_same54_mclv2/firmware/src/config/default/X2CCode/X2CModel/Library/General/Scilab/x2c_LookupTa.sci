...
function [x_sci,y_sci,typ_sci] = x2c_LookupTa(job, arg1, arg2)

thisBlockData.Library = "General";
thisBlockData.block_type_name = "LookupTable1D";
thisBlockData.block_xcosfilename = "x2c_LookupTa";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_LookupTa_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=f(x)";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_LookupTa_"  + used_impl + "_C", 4);
