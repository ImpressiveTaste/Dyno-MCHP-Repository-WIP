// This file was generated by createIFunction.sci on 06-02-2025 03:05
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_TypeConv_"  + used_impl + "_C", 4);
...
if ~strcmp(used_impl,"FiP8_16") then

    define_style = "noLabel=0;displayedLabel=i8 &#8594 i16";

elseif ~strcmp(used_impl,"FiP8_32") then

    define_style = "noLabel=0;displayedLabel=i8 &#8594 i32";

elseif ~strcmp(used_impl,"FiP16_8") then

    define_style = "noLabel=0;displayedLabel=i16 &#8594 i8";

elseif ~strcmp(used_impl,"FiP16_32") then

    define_style = "noLabel=0;displayedLabel=i16 &#8594 i32";

elseif ~strcmp(used_impl,"FiP32_8") then

    define_style = "noLabel=0;displayedLabel=i32 &#8594 i8";

elseif ~strcmp(used_impl,"FiP32_16") then

    define_style = "noLabel=0;displayedLabel=i32 &#8594 i16";

elseif ~strcmp(used_impl,"Bool_FiP16") then

    define_style = "noLabel=0;displayedLabel=b &#8594 i16";

elseif ~strcmp(used_impl,"Bool_FiP32") then

    define_style = "noLabel=0;displayedLabel=b &#8594 i32";

elseif ~strcmp(used_impl,"FiP16_Bool") then

    define_style = "noLabel=0;displayedLabel=i16 &#8594 b";

elseif ~strcmp(used_impl,"FiP32_Bool") then

    define_style = "noLabel=0;displayedLabel=i32 &#8594 b";

else

    define_style = "noLabel=0;displayedLabel=? &#8594 ?";

end

define_in_style = "textOpacity=0";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_TypeConv_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/Dummy.svg"
